...
export function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-border bg-card-bg p-6 shadow-sm card-interactive">
          ...
          <div className="flex gap-2">
            {['1W', '1M', '3M', '1Y', 'All'].map((period) => (
              <button
                ...
                disabled
                title="Coming soon"
                className="rounded-md px-3 py-1 text-sm text-text-muted/50 cursor-not-allowed"
              >
                {period}
              </button>
            ))}
